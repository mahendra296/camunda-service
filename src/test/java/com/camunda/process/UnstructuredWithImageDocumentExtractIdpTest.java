...
@CamundaProcessTest
class UnstructuredWithImageDocumentExtractIdpTest {

    private static final String PROCESS_ID = "unstructured-with-image-document-extract-idp";
    ...
    void deployProcess() {
        client.newDeployResourceCommand()
                .addResourceFromClasspath("workflow/unstructured-with-image-document-extract-idp.bpmn")
                .send()
                .join();
    }

    @Test
    void happyPath_extractsDocumentWithImageAndCompletes() {
